    ...
    <div>
      ...
      <div class="top-bar-right hide-for-small-only" >
        <ul class="menu" style="background-color:#4B646F;">
          <li style="<?php echo $dashboard;?>"><a href="<?php echo base_url();?>therapist"> <span style="color:<?php echo $icon_dashboard;?>;font-weight:bold;">Dashboard</span></a></li>
          <li style="<?php echo $managePatient;?>"><a href="<?php echo base_url();?>therapist/manage_patient"><span style="color:<?php echo $icon_managePatient;?>;font-weight:bold;">Patient</span></a></li>
          <li style="<?php $manageProfile;?>"><a href="<?php echo base_url();?>therapist/manage_profile"><i class="fa fa-cog" style="color:<?php echo $icon_profile;?>" aria-hidden="true"></i> <span style="color:<?php echo $icon_profile;?>;font-weight:bold;">Profile</span></a></li>
