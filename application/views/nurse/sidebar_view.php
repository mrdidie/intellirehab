...
<div class="off-canvas position-left hide-for-large" id="my-info" data-off-canvas data-position="left" style="background-color:#333;">
  ...
  <div class="row column">
    ...
    <ul class="menu vertical" style="color:#fff;">
      ...
      <li style="<?php echo $dashboard;?>"><a href="<?php echo base_url();?>nurse"><i class="fa fa-tachometer" style="color:<?php echo $icon_dashboard;?>" aria-hidden="true"></i> <span style="color:<?php echo $icon_dashboard;?>;font-weight:bold;">Dashboard</span></a></li>
      <li style="<?php echo $managePatient;?>"><a href="<?php echo base_url();?>nurse/manage_patient"><i class="fa fa-users" style="color:<?php echo $icon_managePatient;?>;" aria-hidden="true"></i> <span style="color:<?php echo $icon_managePatient;?>;font-weight:bold;">Patient</span></a></li>
      <li class="menu-text">Setting</li>
      <li style="<?php $manageProfile;?>"><a href="<?php echo base_url();?>nurse/manage_profile"><i class="fa fa-cog" style="color:#ccc;" aria-hidden="true"></i> <span style="color:#ccc;font-weight:bold;">Profile</span></a></li>
