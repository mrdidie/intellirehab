	...
	<div class="small-12 columns">
		<div class="row">
			<div class="small-12 columns">
				...
				<div class="callout">
					<form action="<?php echo base_url();?>researcher/page_edit_patient/<?php echo $action;?>/<?php echo $session;?>" method="POST" data-abide novalidate>
						...
						<div class="row">
							...
							<div class="small-3 columns">
								<input type="date" name="inpPatDateOfBirth" id="inpPatDateOfBirth" value="<?php echo $min->pat_dob;?>" required>
						...
						<div class="row">
							...
							<div class="small-4 columns">
								<input type="text" readonly value="<?php echo getdesc("usim_login","nama_user","id",$min->saved_by);?>">
							</div>
							<div class="small-2 columns">
								<label for="">Date of data entry</label>
							</div>
							<div class="small-4 columns">
								<input type="text" readonly value="<?php echo $min->saved_date;?>">
							</div>
						</div>
						<hr>
						<div class="row">
							...
							<div class="small-2 columns">
								<input type="text" value="<?php echo $min->approval_date;?>" readonly>
							</div>
							<div class="small-2 columns">
								<label for="" class="middle"><strong>Approved By</strong></label>
							</div>
							<div class="small-2 columns">
								<input type="text" value="<?php echo $min->approval_by;?>" readonly>
							</div>
							<div class="small-2 columns">
								<label for="" class="middle"><strong>Status</strong></label>
							</div>
							<div class="small-2 columns">
								<input type="text" readonly value="<?php echo getStatusApproval($min->approval_status);?>">
							</div>
						</div>
						<hr>
						<div class="row">
							<div class="large-12 small-12 columns text-center">
								<input type="hidden" name="hdnTab" value="panel1c">
