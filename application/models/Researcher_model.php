...
class Researcher_model extends CI_Model {
	...
	public function allTherapy($idtherapist){
		...
		$this->db->order_by("tbl_patient_information.pat_researchID");
		$this->db->select("tbl_therapy.pat_researchID, tbl_patient_information.pat_firstname, tbl_therapy.id, tbl_patient_information.pat_rn, tbl_patient_information.session, cli_19, cli_19FollowUp");
	...
	public function allPatient_dashboard($idtherapist,$researchID = "",$session = ""){
	...
	public function kira_haha($researchID, $session){
	...
	public function send_email() {
	    ...
	    $config = Array(
	        ...
	        'smtp_port' => 587, //465,
	        'smtp_user' => 'khairil114@gmail.com',
	        'smtp_pass' => 'syaqinur1989',
	        'smtp_crypto' => 'tls',
	        'smtp_timeout' => '20',
	        'mailtype'  => 'html', 
	        'charset'   => 'iso-8859-1'
	    ...
	    $this->email->from('testing@usim.edu.my', 'Testing Usim');
		$this->email->to('khairil114@gmail.com');
	...
	public function stroke_view($researchID,$session,$jenis){

		if($jenis=="arom"){
			$table = "tbl_stroke_arom";
		} elseif($jenis=="prom"){
			$table = "tbl_stroke_prom";
		} elseif($jenis=="msgarom"){
	...
	public function maklumatDOB($dob){
